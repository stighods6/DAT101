...
export const EGameStatus = { idle: 0, getReady: 1, playing: 2, gameOver: 3, medal: 1 };
...
export const GameProps = {
  ...
  score: 0,
  bestscore: 0,
  aSound: {countDown: null, food: null, gameOver: null, dead: null, running: null},
};
...
function loadGame() {
  ...
  GameProps.sounds = new libSound.TSoundFile("./media/running.mp3");
...
function spawnObstacle() {
  ...
  if (GameProps.status === EGameStatus.playing) {
    const seconds = Math.ceil(Math.random() * 1) + 2;
